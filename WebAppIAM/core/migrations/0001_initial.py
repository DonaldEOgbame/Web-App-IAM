# Generated by Django 5.0 on 2025-07-10 03:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('face_match_threshold', models.FloatField(default=0.7, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)])),
                ('behavior_anomaly_threshold', models.FloatField(default=0.5, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)])),
                ('fingerprint_required', models.BooleanField(default=True)),
                ('high_risk_action', models.CharField(choices=[('ALLOW', 'Allow with monitoring'), ('CHALLENGE', 'Require additional authentication'), ('DENY', 'Deny access')], default='CHALLENGE', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('azure_face_id', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('LOGIN_ATTEMPT', 'Login Attempt'), ('FACE_ENROLL', 'Face Enrollment'), ('FINGERPRINT_ENROLL', 'Fingerprint Enrollment'), ('RISK_EVAL', 'Risk Evaluation'), ('ACCESS_DENIED', 'Access Denied'), ('PASSWORD_CHANGE', 'Password Change'), ('PROFILE_UPDATE', 'Profile Update')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_level', models.CharField(choices=[('ADMIN', 'Admin Only'), ('USER', 'All Users'), ('DEPT', 'Department Specific')], default='USER', max_length=10)),
                ('category', models.CharField(choices=[('GENERAL', 'General'), ('HR', 'HR'), ('FINANCE', 'Finance'), ('IT', 'IT'), ('LEGAL', 'Legal')], default='GENERAL', max_length=20)),
                ...
                ('parent', models.ForeignKey(blank=True, help_text='Previous version of this document, if any.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='versions', to='core.document')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('face_match_score', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(1.0)])),
                ('fingerprint_verified', models.BooleanField(default=False)),
                ('behavior_anomaly_score', models.FloatField(blank=True, null=True)),
